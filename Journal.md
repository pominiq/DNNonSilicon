...
|Expression       |        -|      -|       0|      2|    -|
|FIFO             |        0|      -|    1295|   7252|    -|
|Instance         |        2|    113|   12993|  38968|    -|
|Memory           |        -|      -|       -|      -|    -|
|Multiplexer      |        -|      -|       -|      -|    -|
|Register         |        -|      -|       -|      -|    -|
+-----------------+---------+-------+--------+-------+-----+
|Total            |        2|    113|   14288|  46222|    0|
+-----------------+---------+-------+--------+-------+-----+
|Available        |      280|    220|  106400|  53200|    0|
+-----------------+---------+-------+--------+-------+-----+
|Utilization (%)  |    ~0   |     51|      13|     86|    0|
+-----------------+---------+-------+--------+-------+-----+
...
|Expression       |        -|      -|       0|      2|    -|
|FIFO             |        0|      -|    1295|   7252|    -|
|Instance         |        2|    113|   13240|  38467|    -|
|Memory           |        -|      -|       -|      -|    -|
|Multiplexer      |        -|      -|       -|      -|    -|
|Register         |        -|      -|       -|      -|    -|
+-----------------+---------+-------+--------+-------+-----+
|Total            |        2|    113|   14535|  45721|    0|
+-----------------+---------+-------+--------+-------+-----+
|Available        |      280|    220|  106400|  53200|    0|
+-----------------+---------+-------+--------+-------+-----+
|Utilization (%)  |    ~0   |     51|      13|     85|    0|
+-----------------+---------+-------+--------+-------+-----+


RF8, latency, io_parallel
...
|Expression       |        -|      -|       0|      6|    -|
|FIFO             |        -|      -|       -|      -|    -|
|Instance         |        3|    115|    9760|  33253|    -|
|Memory           |        -|      -|       -|      -|    -|
|Multiplexer      |        -|      -|       -|     92|    -|
|Register         |        -|      -|    2172|      -|    -|
+-----------------+---------+-------+--------+-------+-----+
|Total            |        3|    115|   11932|  33351|    0|
+-----------------+---------+-------+--------+-------+-----+
|Available        |      280|    220|  106400|  53200|    0|
+-----------------+---------+-------+--------+-------+-----+
|Utilization (%)  |        1|     52|      11|     62|    0|
+-----------------+---------+-------+--------+-------+-----+
...
|Expression       |        -|      -|       0|      6|    -|
|FIFO             |        -|      -|       -|      -|    -|
|Instance         |        3|    115|    9914|  33240|    -|
|Memory           |        -|      -|       -|      -|    -|
|Multiplexer      |        -|      -|       -|     95|    -|
|Register         |        -|      -|    2173|      -|    -|
+-----------------+---------+-------+--------+-------+-----+
|Total            |        3|    115|   12087|  33341|    0|
+-----------------+---------+-------+--------+-------+-----+
|Available        |      280|    220|  106400|  53200|    0|
+-----------------+---------+-------+--------+-------+-----+
|Utilization (%)  |        1|     52|      11|     62|    0|
...
RF8, latency, io_parallel, constant sparcity 0.75, acc = 100%
================================================================
== Utilization Estimates
================================================================
* Summary: 
...
CNN RF1, io_stream, constant spar 0.75, 84.83%
...
|Expression       |        -|      -|       0|      2|    -|
|FIFO             |       12|      -|     726|   1784|    -|
|Instance         |        4|    158|    7194|  16047|    -|
|Memory           |        -|      -|       -|      -|    -|
|Multiplexer      |        -|      -|       -|      -|    -|
|Register         |        -|      -|       -|      -|    -|
+-----------------+---------+-------+--------+-------+-----+
|Total            |       16|    158|    7920|  17833|    0|
+-----------------+---------+-------+--------+-------+-----+
|Available        |      280|    220|  106400|  53200|    0|
+-----------------+---------+-------+--------+-------+-----+
|Utilization (%)  |        5|     71|       7|     33|    0|
+-----------------+---------+-------+--------+-------+-----+

CNN RF16, io_stream, constant spar 0.75, 84.83%
