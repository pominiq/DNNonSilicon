...
set DataType0ta0 "[list ap_fixed 16 8 5 3 0 ]"
set structArgument0 [list $DataType0ta0 1 ]
set SpaceName00 "nnet"
set NameSpace0 [list  [list  space $SpaceName00] ]
set structIsPacked0 "0"
set DataType0 [list "nnet::array<ap_fixed<16, 8, 5, 3, 0>, 1>" "struct array" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "layer7_out"
set BitWidth1 "192"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set DataType1ta0 "[list ap_fixed 16 8 5 3 0 ]"
set structArgument1 [list $DataType1ta0 12 ]
set SpaceName10 "nnet"
set NameSpace1 [list  [list  space $SpaceName10] ]
set structIsPacked1 "0"
set DataType1 [list "nnet::array<ap_fixed<16, 8, 5, 3, 0>, 12>" "struct array" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
