...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<dense_weight_t, 320>(w9, "w9.txt");
        nnet::load_weights_from_txt<dense_bias_t, 10>(b9, "b9.txt");
        loaded_weights = true;
    }
#endif
    ...
    nnet::softmax<layer2_t, layer3_t, softmax_config3>(layer2_out, layer3_out); // conv2d_softmax
    ...
    nnet::softmax<layer5_t, layer6_t, softmax_config6>(layer5_out, layer6_out); // conv2d_1_softmax
