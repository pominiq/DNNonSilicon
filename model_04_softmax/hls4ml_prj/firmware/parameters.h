...
struct softmax_config3 : nnet::activ_config {
    ...
    typedef conv2d_softmax_exp_table_t exp_table_t;
    typedef conv2d_softmax_inv_table_t inv_table_t;
};
...
struct softmax_config6 : nnet::activ_config {
    ...
    static const unsigned axis = -1;
    static const nnet::softmax_implementation implementation = nnet::softmax_implementation::stable;
    typedef conv2d_1_softmax_exp_table_t exp_table_t;
    typedef conv2d_1_softmax_inv_table_t inv_table_t;
};
