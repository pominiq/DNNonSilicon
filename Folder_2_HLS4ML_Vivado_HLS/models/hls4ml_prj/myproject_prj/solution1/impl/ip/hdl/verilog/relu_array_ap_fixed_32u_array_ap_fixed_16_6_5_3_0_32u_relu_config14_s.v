...
module relu_array_ap_fixed_32u_array_ap_fixed_16_6_5_3_0_32u_relu_config14_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg    ap_block_state1;
wire   [0:0] icmp_ln1494_fu_1224_p2;
wire   [0:0] icmp_ln1494_1_fu_1230_p2;
wire   [0:0] icmp_ln1494_2_fu_1236_p2;
wire   [0:0] icmp_ln1494_3_fu_1242_p2;
wire   [0:0] icmp_ln1494_4_fu_1248_p2;
wire   [0:0] icmp_ln1494_5_fu_1254_p2;
wire   [0:0] icmp_ln1494_6_fu_1260_p2;
wire   [0:0] icmp_ln1494_7_fu_1266_p2;
wire   [0:0] icmp_ln1494_8_fu_1272_p2;
wire   [0:0] icmp_ln1494_9_fu_1278_p2;
wire   [0:0] icmp_ln1494_10_fu_1284_p2;
wire   [0:0] icmp_ln1494_11_fu_1290_p2;
wire   [0:0] icmp_ln1494_12_fu_1296_p2;
wire   [0:0] icmp_ln1494_13_fu_1302_p2;
wire   [0:0] icmp_ln1494_14_fu_1308_p2;
wire   [0:0] icmp_ln1494_15_fu_1314_p2;
wire   [0:0] icmp_ln1494_16_fu_1320_p2;
wire   [0:0] icmp_ln1494_17_fu_1326_p2;
wire   [0:0] icmp_ln1494_18_fu_1332_p2;
wire   [0:0] icmp_ln1494_19_fu_1338_p2;
wire   [0:0] icmp_ln1494_20_fu_1344_p2;
wire   [0:0] icmp_ln1494_21_fu_1350_p2;
wire   [0:0] icmp_ln1494_22_fu_1356_p2;
wire   [0:0] icmp_ln1494_23_fu_1362_p2;
wire   [0:0] icmp_ln1494_24_fu_1368_p2;
wire   [0:0] icmp_ln1494_25_fu_1374_p2;
wire   [0:0] icmp_ln1494_26_fu_1380_p2;
wire   [0:0] icmp_ln1494_27_fu_1386_p2;
wire   [0:0] icmp_ln1494_28_fu_1392_p2;
wire   [0:0] icmp_ln1494_29_fu_1398_p2;
wire   [0:0] icmp_ln1494_30_fu_1404_p2;
wire   [0:0] icmp_ln1494_31_fu_1410_p2;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (io_acc_block_signal_op166 == 1'b0) | (io_acc_block_signal_op69 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (io_acc_block_signal_op166 == 1'b0) | (io_acc_block_signal_op69 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (io_acc_block_signal_op166 == 1'b0) | (io_acc_block_signal_op69 == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_ready = internal_ap_ready;

assign icmp_ln1494_10_fu_1284_p2 = (($signed(data_V_data_10_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_11_fu_1290_p2 = (($signed(data_V_data_11_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_12_fu_1296_p2 = (($signed(data_V_data_12_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_13_fu_1302_p2 = (($signed(data_V_data_13_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_14_fu_1308_p2 = (($signed(data_V_data_14_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_15_fu_1314_p2 = (($signed(data_V_data_15_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_16_fu_1320_p2 = (($signed(data_V_data_16_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_17_fu_1326_p2 = (($signed(data_V_data_17_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_18_fu_1332_p2 = (($signed(data_V_data_18_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_19_fu_1338_p2 = (($signed(data_V_data_19_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_1_fu_1230_p2 = (($signed(data_V_data_1_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_20_fu_1344_p2 = (($signed(data_V_data_20_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_21_fu_1350_p2 = (($signed(data_V_data_21_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_22_fu_1356_p2 = (($signed(data_V_data_22_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_23_fu_1362_p2 = (($signed(data_V_data_23_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_24_fu_1368_p2 = (($signed(data_V_data_24_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_25_fu_1374_p2 = (($signed(data_V_data_25_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_26_fu_1380_p2 = (($signed(data_V_data_26_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_27_fu_1386_p2 = (($signed(data_V_data_27_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_28_fu_1392_p2 = (($signed(data_V_data_28_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_29_fu_1398_p2 = (($signed(data_V_data_29_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_2_fu_1236_p2 = (($signed(data_V_data_2_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_30_fu_1404_p2 = (($signed(data_V_data_30_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_31_fu_1410_p2 = (($signed(data_V_data_31_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_3_fu_1242_p2 = (($signed(data_V_data_3_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_4_fu_1248_p2 = (($signed(data_V_data_4_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_5_fu_1254_p2 = (($signed(data_V_data_5_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_6_fu_1260_p2 = (($signed(data_V_data_6_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_7_fu_1266_p2 = (($signed(data_V_data_7_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_8_fu_1272_p2 = (($signed(data_V_data_8_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_9_fu_1278_p2 = (($signed(data_V_data_9_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln1494_fu_1224_p2 = (($signed(data_V_data_0_V_dout) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign io_acc_block_signal_op166 = (res_V_data_9_V_full_n & res_V_data_8_V_full_n & res_V_data_7_V_full_n & res_V_data_6_V_full_n & res_V_data_5_V_full_n & res_V_data_4_V_full_n & res_V_data_3_V_full_n & res_V_data_31_V_full_n & res_V_data_30_V_full_n & res_V_data_2_V_full_n & res_V_data_29_V_full_n & res_V_data_28_V_full_n & res_V_data_27_V_full_n & res_V_data_26_V_full_n & res_V_data_25_V_full_n & res_V_data_24_V_full_n & res_V_data_23_V_full_n & res_V_data_22_V_full_n & res_V_data_21_V_full_n & res_V_data_20_V_full_n & res_V_data_1_V_full_n & res_V_data_19_V_full_n & res_V_data_18_V_full_n & res_V_data_17_V_full_n & res_V_data_16_V_full_n & res_V_data_15_V_full_n & res_V_data_14_V_full_n & res_V_data_13_V_full_n & res_V_data_12_V_full_n & res_V_data_11_V_full_n & res_V_data_10_V_full_n & res_V_data_0_V_full_n);
...
assign res_V_data_0_V_din = ((icmp_ln1494_fu_1224_p2[0:0] === 1'b1) ? data_V_data_0_V_dout : 16'd0);

assign res_V_data_10_V_din = ((icmp_ln1494_10_fu_1284_p2[0:0] === 1'b1) ? data_V_data_10_V_dout : 16'd0);

assign res_V_data_11_V_din = ((icmp_ln1494_11_fu_1290_p2[0:0] === 1'b1) ? data_V_data_11_V_dout : 16'd0);

assign res_V_data_12_V_din = ((icmp_ln1494_12_fu_1296_p2[0:0] === 1'b1) ? data_V_data_12_V_dout : 16'd0);

assign res_V_data_13_V_din = ((icmp_ln1494_13_fu_1302_p2[0:0] === 1'b1) ? data_V_data_13_V_dout : 16'd0);

assign res_V_data_14_V_din = ((icmp_ln1494_14_fu_1308_p2[0:0] === 1'b1) ? data_V_data_14_V_dout : 16'd0);

assign res_V_data_15_V_din = ((icmp_ln1494_15_fu_1314_p2[0:0] === 1'b1) ? data_V_data_15_V_dout : 16'd0);

assign res_V_data_16_V_din = ((icmp_ln1494_16_fu_1320_p2[0:0] === 1'b1) ? data_V_data_16_V_dout : 16'd0);

assign res_V_data_17_V_din = ((icmp_ln1494_17_fu_1326_p2[0:0] === 1'b1) ? data_V_data_17_V_dout : 16'd0);

assign res_V_data_18_V_din = ((icmp_ln1494_18_fu_1332_p2[0:0] === 1'b1) ? data_V_data_18_V_dout : 16'd0);

assign res_V_data_19_V_din = ((icmp_ln1494_19_fu_1338_p2[0:0] === 1'b1) ? data_V_data_19_V_dout : 16'd0);

assign res_V_data_1_V_din = ((icmp_ln1494_1_fu_1230_p2[0:0] === 1'b1) ? data_V_data_1_V_dout : 16'd0);

assign res_V_data_20_V_din = ((icmp_ln1494_20_fu_1344_p2[0:0] === 1'b1) ? data_V_data_20_V_dout : 16'd0);

assign res_V_data_21_V_din = ((icmp_ln1494_21_fu_1350_p2[0:0] === 1'b1) ? data_V_data_21_V_dout : 16'd0);

assign res_V_data_22_V_din = ((icmp_ln1494_22_fu_1356_p2[0:0] === 1'b1) ? data_V_data_22_V_dout : 16'd0);

assign res_V_data_23_V_din = ((icmp_ln1494_23_fu_1362_p2[0:0] === 1'b1) ? data_V_data_23_V_dout : 16'd0);

assign res_V_data_24_V_din = ((icmp_ln1494_24_fu_1368_p2[0:0] === 1'b1) ? data_V_data_24_V_dout : 16'd0);

assign res_V_data_25_V_din = ((icmp_ln1494_25_fu_1374_p2[0:0] === 1'b1) ? data_V_data_25_V_dout : 16'd0);

assign res_V_data_26_V_din = ((icmp_ln1494_26_fu_1380_p2[0:0] === 1'b1) ? data_V_data_26_V_dout : 16'd0);

assign res_V_data_27_V_din = ((icmp_ln1494_27_fu_1386_p2[0:0] === 1'b1) ? data_V_data_27_V_dout : 16'd0);

assign res_V_data_28_V_din = ((icmp_ln1494_28_fu_1392_p2[0:0] === 1'b1) ? data_V_data_28_V_dout : 16'd0);

assign res_V_data_29_V_din = ((icmp_ln1494_29_fu_1398_p2[0:0] === 1'b1) ? data_V_data_29_V_dout : 16'd0);

assign res_V_data_2_V_din = ((icmp_ln1494_2_fu_1236_p2[0:0] === 1'b1) ? data_V_data_2_V_dout : 16'd0);

assign res_V_data_30_V_din = ((icmp_ln1494_30_fu_1404_p2[0:0] === 1'b1) ? data_V_data_30_V_dout : 16'd0);

assign res_V_data_31_V_din = ((icmp_ln1494_31_fu_1410_p2[0:0] === 1'b1) ? data_V_data_31_V_dout : 16'd0);

assign res_V_data_3_V_din = ((icmp_ln1494_3_fu_1242_p2[0:0] === 1'b1) ? data_V_data_3_V_dout : 16'd0);

assign res_V_data_4_V_din = ((icmp_ln1494_4_fu_1248_p2[0:0] === 1'b1) ? data_V_data_4_V_dout : 16'd0);

assign res_V_data_5_V_din = ((icmp_ln1494_5_fu_1254_p2[0:0] === 1'b1) ? data_V_data_5_V_dout : 16'd0);

assign res_V_data_6_V_din = ((icmp_ln1494_6_fu_1260_p2[0:0] === 1'b1) ? data_V_data_6_V_dout : 16'd0);

assign res_V_data_7_V_din = ((icmp_ln1494_7_fu_1266_p2[0:0] === 1'b1) ? data_V_data_7_V_dout : 16'd0);

assign res_V_data_8_V_din = ((icmp_ln1494_8_fu_1272_p2[0:0] === 1'b1) ? data_V_data_8_V_dout : 16'd0);

assign res_V_data_9_V_din = ((icmp_ln1494_9_fu_1278_p2[0:0] === 1'b1) ? data_V_data_9_V_dout : 16'd0);

assign start_out = real_start;

endmodule //relu_array_ap_fixed_32u_array_ap_fixed_16_6_5_3_0_32u_relu_config14_s
