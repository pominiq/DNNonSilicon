...
struct dense_array_ap_fixed_8u_array_ap_fixed_16_6_5_3_0_10u_config9_s : public sc_module {
    ...
    sc_signal< sc_lv<16> > tmp_data_0_V_reg_1254;
    sc_signal< sc_logic > ap_CS_fsm_state64;
    sc_signal< sc_lv<16> > tmp_data_1_V_reg_1259;
    sc_signal< sc_lv<16> > tmp_data_2_V_reg_1264;
    sc_signal< sc_lv<16> > tmp_data_3_V_reg_1269;
    sc_signal< sc_lv<16> > tmp_data_4_V_reg_1274;
    sc_signal< sc_lv<16> > tmp_data_5_V_reg_1279;
    sc_signal< sc_lv<16> > tmp_data_6_V_reg_1284;
    sc_signal< sc_lv<16> > tmp_data_7_V_reg_1289;
    sc_signal< sc_lv<16> > tmp_data_8_V_reg_1294;
    sc_signal< sc_lv<16> > tmp_data_9_V_reg_1299;
    ...
    static const sc_lv<64> ap_ST_fsm_state65;
