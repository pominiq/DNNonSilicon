...
reg   [0:0] and_ln289_2_reg_1055;
reg   [31:0] sX_2_load_reg_1023;
wire   [0:0] icmp_ln289_fu_378_p2;
reg   [0:0] icmp_ln289_reg_1028;
reg   [31:0] sY_2_load_reg_1033;
wire   [0:0] icmp_ln289_1_fu_388_p2;
reg   [0:0] icmp_ln289_1_reg_1038;
reg   [31:0] pY_2_load_reg_1043;
reg   [31:0] pX_2_load_reg_1049;
wire   [0:0] and_ln289_2_fu_446_p2;
...
wire   [31:0] select_ln323_fu_1003_p3;
reg   [31:0] ap_phi_mux_storemerge_phi_fu_275_p4;
reg    ap_block_state15;
wire   [0:0] icmp_ln313_fu_936_p2;
wire   [0:0] icmp_ln317_fu_982_p2;
reg    grp_dense_latency_ap_fixed_ap_fixed_config5_mult_0_0_0_0_0_0_0_0_0_fu_282_ap_start_reg;
reg   [14:0] ap_NS_fsm;
wire    ap_NS_fsm_state2;
wire   [31:0] select_ln328_fu_957_p3;
wire   [31:0] add_ln321_fu_987_p2;
wire   [31:0] add_ln326_fu_941_p2;
wire   [30:0] tmp_fu_398_p4;
wire   [30:0] tmp_51_fu_418_p4;
wire   [0:0] icmp_ln289_2_fu_408_p2;
wire   [0:0] icmp_ln289_3_fu_428_p2;
wire   [0:0] and_ln289_1_fu_440_p2;
wire   [0:0] and_ln289_fu_434_p2;
wire   [31:0] add_ln328_fu_952_p2;
wire   [31:0] add_ln323_fu_998_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_NS_fsm_state2) & (1'b1 == ap_CS_fsm_state1) & (1'd1 == and_ln289_2_fu_446_p2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_421)) begin
        if ((icmp_ln313_fu_936_p2 == 1'd1)) begin
            pX_2 <= 32'd0;
        end else if ((icmp_ln313_fu_936_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_601)) begin
        if ((icmp_ln317_fu_982_p2 == 1'd1)) begin
            pY_2 <= 32'd0;
        end else if ((icmp_ln317_fu_982_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1055)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce) & (icmp_ln313_fu_936_p2 == 1'd1))) begin
        sY_2 <= ap_phi_mux_storemerge_phi_fu_275_p4;
    end
end

always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | (~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1055)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state15) & (icmp_ln313_fu_936_p2 == 1'd1))) begin
        if ((icmp_ln317_fu_982_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1055)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_ce) & ((1'b1 == ap_CS_fsm_state14) | (1'b1 == ap_CS_fsm_state13) | (1'b1 == ap_CS_fsm_state12) | (1'b1 == ap_CS_fsm_state11) | (1'b1 == ap_CS_fsm_state10) | (1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state7) | (1'b1 == ap_CS_fsm_state6) | (1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | (~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1055)) & (1'b1 == ap_CS_fsm_state15))))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state15) & (1'd1 == and_ln289_2_reg_1055))) begin
...
always @ (*) begin
    if ((~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1055)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce) & (1'd1 == and_ln289_2_reg_1055))) begin
...
assign add_ln321_fu_987_p2 = (pY_2_load_reg_1043 + 32'd1);

assign add_ln323_fu_998_p2 = (sY_2_load_reg_1033 + 32'd1);

assign add_ln326_fu_941_p2 = (pX_2_load_reg_1049 + 32'd1);

assign add_ln328_fu_952_p2 = (sX_2_load_reg_1023 + 32'd1);

assign and_ln289_1_fu_440_p2 = (icmp_ln289_3_fu_428_p2 & icmp_ln289_2_fu_408_p2);

assign and_ln289_2_fu_446_p2 = (and_ln289_fu_434_p2 & and_ln289_1_fu_440_p2);

assign and_ln289_fu_434_p2 = (icmp_ln289_fu_378_p2 & icmp_ln289_1_fu_388_p2);
...
always @ (*) begin
    ap_block_state15 = ((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1055));
end

always @ (*) begin
    ap_block_state15_ignore_call0 = ((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1055));
end

always @ (*) begin
    ap_condition_421 = (~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1055)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce));
end

always @ (*) begin
    ap_condition_601 = (~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1055)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce) & (icmp_ln313_fu_936_p2 == 1'd1));
end
...
assign icmp_ln289_1_fu_388_p2 = ((sY_2 == 32'd2) ? 1'b1 : 1'b0);

assign icmp_ln289_2_fu_408_p2 = (($signed(tmp_fu_398_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);

assign icmp_ln289_3_fu_428_p2 = (($signed(tmp_51_fu_418_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);

assign icmp_ln289_fu_378_p2 = ((sX_2 == 32'd2) ? 1'b1 : 1'b0);

assign icmp_ln313_fu_936_p2 = ((pX_2_load_reg_1049 == 32'd5) ? 1'b1 : 1'b0);

assign icmp_ln317_fu_982_p2 = ((pY_2_load_reg_1043 == 32'd5) ? 1'b1 : 1'b0);

assign io_acc_block_signal_op149 = (res_stream_V_data_7_V_full_n & res_stream_V_data_6_V_full_n & res_stream_V_data_5_V_full_n & res_stream_V_data_4_V_full_n & res_stream_V_data_3_V_full_n & res_stream_V_data_2_V_full_n & res_stream_V_data_1_V_full_n & res_stream_V_data_0_V_full_n);

assign res_stream_V_data_0_V_din = grp_dense_latency_ap_fixed_ap_fixed_config5_mult_0_0_0_0_0_0_0_0_0_fu_282_ap_return_0;

assign res_stream_V_data_1_V_din = grp_dense_latency_ap_fixed_ap_fixed_config5_mult_0_0_0_0_0_0_0_0_0_fu_282_ap_return_1;

assign res_stream_V_data_2_V_din = grp_dense_latency_ap_fixed_ap_fixed_config5_mult_0_0_0_0_0_0_0_0_0_fu_282_ap_return_2;

assign res_stream_V_data_3_V_din = grp_dense_latency_ap_fixed_ap_fixed_config5_mult_0_0_0_0_0_0_0_0_0_fu_282_ap_return_3;

assign res_stream_V_data_4_V_din = grp_dense_latency_ap_fixed_ap_fixed_config5_mult_0_0_0_0_0_0_0_0_0_fu_282_ap_return_4;

assign res_stream_V_data_5_V_din = grp_dense_latency_ap_fixed_ap_fixed_config5_mult_0_0_0_0_0_0_0_0_0_fu_282_ap_return_5;

assign res_stream_V_data_6_V_din = grp_dense_latency_ap_fixed_ap_fixed_config5_mult_0_0_0_0_0_0_0_0_0_fu_282_ap_return_6;

assign res_stream_V_data_7_V_din = grp_dense_latency_ap_fixed_ap_fixed_config5_mult_0_0_0_0_0_0_0_0_0_fu_282_ap_return_7;

assign select_ln323_fu_1003_p3 = ((icmp_ln289_1_reg_1038[0:0] === 1'b1) ? 32'd2 : add_ln323_fu_998_p2);

assign select_ln328_fu_957_p3 = ((icmp_ln289_reg_1028[0:0] === 1'b1) ? 32'd2 : add_ln328_fu_952_p2);

assign tmp_51_fu_418_p4 = {{pX_2[31:1]}};

assign tmp_fu_398_p4 = {{pY_2[31:1]}};
