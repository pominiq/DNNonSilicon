...
reg   [15:0] kernel_data_V_1192;
reg   [15:0] kernel_data_V_4;
reg   [15:0] kernel_data_V_7;
reg   [15:0] kernel_data_V_2193;
...
reg    line_buffer_Array_V_1191_0_ce0;
reg    line_buffer_Array_V_1191_0_we0;
wire   [15:0] line_buffer_Array_V_1191_0_q0;
...
reg   [15:0] tmp_data_0_V_851_reg_305;
reg   [15:0] tmp_data_1_V_849_reg_316;
reg   [15:0] tmp_data_2_V_847_reg_327;
reg   [15:0] tmp_data_3_V_845_reg_338;
...
reg   [15:0] kernel_data_V_2193_load_reg_1011;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 6'd1;
#0 kernel_data_V_1192 = 16'd0;
#0 kernel_data_V_4 = 16'd0;
#0 kernel_data_V_7 = 16'd0;
#0 kernel_data_V_2193 = 16'd0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln129_reg_1093_pp1_iter2_reg == 1'd0) & (ap_enable_reg_pp1_iter3 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        ...
        tmp_data_0_V_851_reg_305 <= 16'd65422;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln129_reg_1093_pp1_iter2_reg == 1'd0) & (ap_enable_reg_pp1_iter3 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        ...
        tmp_data_1_V_849_reg_316 <= 16'd65527;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln129_reg_1093_pp1_iter2_reg == 1'd0) & (ap_enable_reg_pp1_iter3 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        ...
        tmp_data_2_V_847_reg_327 <= 16'd65514;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln129_reg_1093_pp1_iter2_reg == 1'd0) & (ap_enable_reg_pp1_iter3 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        ...
        tmp_data_3_V_845_reg_338 <= 16'd65533;
    end
end
...
always @ (*) begin
    if (((data_V_data_V_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        line_buffer_Array_V_1191_0_ce0 = 1'd1;
    end else begin
        line_buffer_Array_V_1191_0_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((data_V_data_V_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        line_buffer_Array_V_1191_0_we0 = 1'd1;
    end else begin
        line_buffer_Array_V_1191_0_we0 = 1'b0;
    end
end
...
assign acc_0_V_fu_887_p2 = (tmp_20_fu_874_p6 + trunc_ln6_reg_1117);
...
assign icmp_ln289_6_fu_627_p2 = (($signed(tmp_35_fu_617_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
assign outidx3_address0 = zext_ln133_fu_651_p1;
...
assign select_ln19_2_fu_761_p3 = ((icmp_ln19_3_fu_703_p2[0:0] === 1'b1) ? kernel_data_V_3194 : kernel_data_V_2193);

assign select_ln19_3_fu_775_p3 = ((icmp_ln19_1_fu_691_p2[0:0] === 1'b1) ? kernel_data_V_1192 : kernel_data_V_0);
...
assign select_ln203_fu_501_p3 = ((trunc_ln201_fu_497_p1[0:0] === 1'b1) ? kernel_data_V_2193_load_reg_1011 : kernel_data_V_1192);
...
assign tmp_35_fu_617_p4 = {{pX_3[31:1]}};
