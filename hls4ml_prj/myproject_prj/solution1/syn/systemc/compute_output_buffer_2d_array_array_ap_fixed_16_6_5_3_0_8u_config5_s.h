...
struct compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_8u_config5_s : public sc_module {
    ...
    sc_signal< sc_lv<1> > and_ln289_2_reg_1199;
    sc_signal< sc_lv<16> > kernel_data_V_1_27_ret_reg_987;
    sc_signal< sc_lv<16> > kernel_data_V_1_26_ret_reg_992;
    sc_signal< sc_lv<16> > kernel_data_V_1_25_ret_reg_997;
    sc_signal< sc_lv<16> > kernel_data_V_1_24_ret_reg_1002;
    sc_signal< sc_lv<16> > kernel_data_V_1_15_ret_reg_1007;
    sc_signal< sc_lv<16> > kernel_data_V_1_14_ret_reg_1012;
    sc_signal< sc_lv<16> > kernel_data_V_1_13_ret_reg_1017;
    sc_signal< sc_lv<16> > kernel_data_V_1_12_ret_reg_1022;
    sc_signal< sc_lv<16> > kernel_data_V_1_3_ret_reg_1027;
    sc_signal< sc_lv<16> > kernel_data_V_1_2_ret_reg_1032;
    sc_signal< sc_lv<16> > kernel_data_V_1_1_ret_reg_1037;
    sc_signal< sc_lv<16> > kernel_data_V_1_0_ret_reg_1042;
    sc_signal< sc_lv<16> > kernel_data_V_1_4_ret_reg_1047;
    sc_signal< sc_lv<16> > kernel_data_V_1_5_ret_reg_1052;
    sc_signal< sc_lv<16> > kernel_data_V_1_6_ret_reg_1057;
    sc_signal< sc_lv<16> > kernel_data_V_1_7_ret_reg_1062;
    sc_signal< sc_lv<16> > kernel_data_V_1_8_ret_reg_1067;
    sc_signal< sc_lv<16> > kernel_data_V_1_9_ret_reg_1072;
    sc_signal< sc_lv<16> > kernel_data_V_1_10_ret_reg_1077;
    sc_signal< sc_lv<16> > kernel_data_V_1_11_ret_reg_1082;
    sc_signal< sc_lv<16> > kernel_data_V_1_16_ret_reg_1087;
    sc_signal< sc_lv<16> > kernel_data_V_1_17_ret_reg_1092;
    sc_signal< sc_lv<16> > kernel_data_V_1_18_ret_reg_1097;
    sc_signal< sc_lv<16> > kernel_data_V_1_19_ret_reg_1102;
    sc_signal< sc_lv<16> > kernel_data_V_1_20_ret_reg_1107;
    sc_signal< sc_lv<16> > kernel_data_V_1_21_ret_reg_1112;
    sc_signal< sc_lv<16> > kernel_data_V_1_22_ret_reg_1117;
    sc_signal< sc_lv<16> > kernel_data_V_1_23_ret_reg_1122;
    sc_signal< sc_lv<16> > kernel_data_V_1_28_ret_reg_1127;
    sc_signal< sc_lv<16> > kernel_data_V_1_29_ret_reg_1132;
    sc_signal< sc_lv<16> > kernel_data_V_1_30_ret_reg_1137;
    sc_signal< sc_lv<16> > kernel_data_V_1_31_ret_reg_1142;
    sc_signal< sc_lv<16> > kernel_data_V_1_32_ret_reg_1147;
    sc_signal< sc_lv<16> > kernel_data_V_1_33_ret_reg_1152;
    sc_signal< sc_lv<16> > kernel_data_V_1_34_ret_reg_1157;
    sc_signal< sc_lv<16> > kernel_data_V_1_35_ret_reg_1162;
    sc_signal< sc_lv<32> > sX_2_load_reg_1167;
    sc_signal< sc_lv<1> > icmp_ln289_fu_786_p2;
    sc_signal< sc_lv<1> > icmp_ln289_reg_1172;
    sc_signal< sc_lv<32> > sY_2_load_reg_1177;
    sc_signal< sc_lv<1> > icmp_ln289_1_fu_796_p2;
    sc_signal< sc_lv<1> > icmp_ln289_1_reg_1182;
    sc_signal< sc_lv<32> > pY_2_load_reg_1187;
    sc_signal< sc_lv<32> > pX_2_load_reg_1193;
    ...
    sc_signal< bool > ap_block_state15_ignore_call0;
    ...
    sc_signal< sc_lv<31> > tmp_56_fu_826_p4;
    ...
    void thread_ap_block_state15_ignore_call0();
