...
reg   [0:0] and_ln289_2_reg_1199;
reg   [15:0] kernel_data_V_1_27_ret_reg_987;
reg   [15:0] kernel_data_V_1_26_ret_reg_992;
reg   [15:0] kernel_data_V_1_25_ret_reg_997;
reg   [15:0] kernel_data_V_1_24_ret_reg_1002;
reg   [15:0] kernel_data_V_1_15_ret_reg_1007;
reg   [15:0] kernel_data_V_1_14_ret_reg_1012;
reg   [15:0] kernel_data_V_1_13_ret_reg_1017;
reg   [15:0] kernel_data_V_1_12_ret_reg_1022;
reg   [15:0] kernel_data_V_1_3_ret_reg_1027;
reg   [15:0] kernel_data_V_1_2_ret_reg_1032;
reg   [15:0] kernel_data_V_1_1_ret_reg_1037;
reg   [15:0] kernel_data_V_1_0_ret_reg_1042;
reg   [15:0] kernel_data_V_1_4_ret_reg_1047;
reg   [15:0] kernel_data_V_1_5_ret_reg_1052;
reg   [15:0] kernel_data_V_1_6_ret_reg_1057;
reg   [15:0] kernel_data_V_1_7_ret_reg_1062;
reg   [15:0] kernel_data_V_1_8_ret_reg_1067;
reg   [15:0] kernel_data_V_1_9_ret_reg_1072;
reg   [15:0] kernel_data_V_1_10_ret_reg_1077;
reg   [15:0] kernel_data_V_1_11_ret_reg_1082;
reg   [15:0] kernel_data_V_1_16_ret_reg_1087;
reg   [15:0] kernel_data_V_1_17_ret_reg_1092;
reg   [15:0] kernel_data_V_1_18_ret_reg_1097;
reg   [15:0] kernel_data_V_1_19_ret_reg_1102;
reg   [15:0] kernel_data_V_1_20_ret_reg_1107;
reg   [15:0] kernel_data_V_1_21_ret_reg_1112;
reg   [15:0] kernel_data_V_1_22_ret_reg_1117;
reg   [15:0] kernel_data_V_1_23_ret_reg_1122;
reg   [15:0] kernel_data_V_1_28_ret_reg_1127;
reg   [15:0] kernel_data_V_1_29_ret_reg_1132;
reg   [15:0] kernel_data_V_1_30_ret_reg_1137;
reg   [15:0] kernel_data_V_1_31_ret_reg_1142;
reg   [15:0] kernel_data_V_1_32_ret_reg_1147;
reg   [15:0] kernel_data_V_1_33_ret_reg_1152;
reg   [15:0] kernel_data_V_1_34_ret_reg_1157;
reg   [15:0] kernel_data_V_1_35_ret_reg_1162;
reg   [31:0] sX_2_load_reg_1167;
wire   [0:0] icmp_ln289_fu_786_p2;
reg   [0:0] icmp_ln289_reg_1172;
reg   [31:0] sY_2_load_reg_1177;
wire   [0:0] icmp_ln289_1_fu_796_p2;
reg   [0:0] icmp_ln289_1_reg_1182;
reg   [31:0] pY_2_load_reg_1187;
reg   [31:0] pX_2_load_reg_1193;
...
always @ (posedge ap_clk) begin
    if ((~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1199)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce) & (icmp_ln313_fu_900_p2 == 1'd1))) begin
        sY_2 <= ap_phi_mux_storemerge_phi_fu_275_p4;
    end
end

always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | (~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1199)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state15) & (icmp_ln313_fu_900_p2 == 1'd1))) begin
        if ((icmp_ln317_fu_946_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1199)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state15) & (1'd1 == and_ln289_2_reg_1199))) begin
...
always @ (*) begin
    if ((~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1199)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce) & (1'd1 == and_ln289_2_reg_1199))) begin
...
assign add_ln321_fu_951_p2 = (pY_2_load_reg_1187 + 32'd1);

assign add_ln323_fu_962_p2 = (sY_2_load_reg_1177 + 32'd1);

assign add_ln326_fu_905_p2 = (pX_2_load_reg_1193 + 32'd1);

assign add_ln328_fu_916_p2 = (sX_2_load_reg_1167 + 32'd1);
...
always @ (*) begin
    ap_block_state15 = ((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1199));
end

always @ (*) begin
    ap_block_state15_ignore_call0 = ((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1199));
end

always @ (*) begin
    ap_condition_422 = (~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1199)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce));
end

always @ (*) begin
    ap_condition_599 = (~((io_acc_block_signal_op149 == 1'b0) & (1'd1 == and_ln289_2_reg_1199)) & (1'b1 == ap_CS_fsm_state15) & (1'b1 == ap_ce) & (icmp_ln313_fu_900_p2 == 1'd1));
end
...
assign icmp_ln289_3_fu_836_p2 = (($signed(tmp_56_fu_826_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);

assign icmp_ln289_fu_786_p2 = ((sX_2 == 32'd2) ? 1'b1 : 1'b0);

assign icmp_ln313_fu_900_p2 = ((pX_2_load_reg_1193 == 32'd5) ? 1'b1 : 1'b0);

assign icmp_ln317_fu_946_p2 = ((pY_2_load_reg_1187 == 32'd5) ? 1'b1 : 1'b0);
...
assign select_ln323_fu_967_p3 = ((icmp_ln289_1_reg_1182[0:0] === 1'b1) ? 32'd2 : add_ln323_fu_962_p2);

assign select_ln328_fu_921_p3 = ((icmp_ln289_reg_1172[0:0] === 1'b1) ? 32'd2 : add_ln328_fu_916_p2);

assign tmp_56_fu_826_p4 = {{pX_2[31:1]}};
