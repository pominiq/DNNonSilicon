...
reg   [15:0] tmp_data_0_V_reg_1000;
reg   [15:0] DataOut_V_8_reg_1005;
reg   [15:0] DataOut_V_reg_1010;
reg   [15:0] kernel_data_V_2144_load_reg_1015;
reg   [15:0] kernel_data_V_5_load_reg_1020;
reg   [15:0] kernel_data_V_8_load_reg_1025;
wire   [9:0] add_ln79_fu_479_p2;
reg   [9:0] add_ln79_reg_1030;
wire   [1:0] i_iw_fu_491_p2;
wire    ap_CS_fsm_state3;
reg   [31:0] sX_3_load_reg_1046;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln289_fu_577_p2;
reg   [0:0] icmp_ln289_reg_1051;
reg   [31:0] sY_3_load_reg_1056;
wire   [0:0] icmp_ln289_4_fu_587_p2;
reg   [0:0] icmp_ln289_4_reg_1061;
reg   [31:0] pY_3_load_reg_1066;
reg   [31:0] pX_3_load_reg_1072;
...
reg   [5:0] w_index_reg_1092;
reg    ap_enable_reg_pp1_iter0;
wire   [0:0] icmp_ln129_fu_663_p2;
reg   [0:0] icmp_ln129_reg_1097;
wire   [31:0] select_ln148_fu_892_p3;
...
wire   [15:0] acc_0_V_fu_870_p2;
wire   [15:0] ap_phi_reg_pp1_iter1_tmp_data_3_V_reg_349;
wire   [15:0] ap_phi_reg_pp1_iter1_tmp_data_2_V_reg_368;
wire   [15:0] ap_phi_reg_pp1_iter1_tmp_data_1_V_reg_387;
wire   [15:0] ap_phi_reg_pp1_iter1_tmp_data_0_V_2_reg_406;
wire   [31:0] select_ln323_fu_967_p3;
reg   [31:0] ap_phi_mux_storemerge_i_i_phi_fu_428_p4;
wire   [0:0] icmp_ln313_fu_900_p2;
wire   [0:0] icmp_ln317_fu_946_p2;
...
wire   [31:0] select_ln328_fu_921_p3;
wire   [31:0] add_ln321_fu_951_p2;
wire   [31:0] add_ln326_fu_905_p2;
wire   [30:0] tmp_fu_597_p4;
wire   [30:0] tmp_7_fu_617_p4;
...
wire  signed [15:0] select_ln19_7_fu_831_p3;
wire  signed [25:0] r_V_fu_993_p2;
wire   [15:0] tmp_21_fu_856_p6;
wire   [15:0] trunc_ln5_fu_847_p4;
wire   [31:0] in_index_fu_880_p2;
wire   [0:0] icmp_ln148_fu_886_p2;
wire   [31:0] add_ln328_fu_916_p2;
wire   [31:0] add_ln323_fu_962_p2;
reg   [5:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078)) & (1'b1 == ap_CS_fsm_state7) & (icmp_ln79_fu_987_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln129_reg_1097 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((~((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078)) & (icmp_ln79_fu_987_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_239)) begin
        if ((icmp_ln313_fu_900_p2 == 1'd1)) begin
            pX_3 <= 32'd0;
        end else if ((icmp_ln313_fu_900_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_345)) begin
        if ((icmp_ln317_fu_946_p2 == 1'd1)) begin
            pY_3 <= 32'd0;
        end else if ((icmp_ln317_fu_946_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((outidx_q0 == 2'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        tmp_data_0_V_2_reg_406 <= acc_0_V_fu_870_p2;
    end else if ((((outidx_q0 == 2'd1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((outidx_q0 == 2'd2) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((outidx_q0 == 2'd3) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln129_reg_1097 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        ...
        tmp_data_0_V_751_reg_305 <= 16'd65318;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln129_reg_1097 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        ...
        tmp_data_1_V_749_reg_316 <= 16'd65469;
    end
end

always @ (posedge ap_clk) begin
    if (((outidx_q0 == 2'd1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        tmp_data_1_V_reg_387 <= acc_0_V_fu_870_p2;
    end else if ((((outidx_q0 == 2'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((outidx_q0 == 2'd2) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((outidx_q0 == 2'd3) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln129_reg_1097 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        ...
        tmp_data_2_V_747_reg_327 <= 16'd64914;
    end
end

always @ (posedge ap_clk) begin
    if (((outidx_q0 == 2'd2) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        tmp_data_2_V_reg_368 <= acc_0_V_fu_870_p2;
    end else if ((((outidx_q0 == 2'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((outidx_q0 == 2'd1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((outidx_q0 == 2'd3) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln129_reg_1097 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        ...
        tmp_data_3_V_745_reg_338 <= 16'd60;
    end
end

always @ (posedge ap_clk) begin
    if ((((outidx_q0 == 2'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((outidx_q0 == 2'd1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((outidx_q0 == 2'd2) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)))) begin
        tmp_data_3_V_reg_349 <= tmp_data_3_V_745_reg_338;
    end else if (((outidx_q0 == 2'd3) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((~((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078)) & (1'b1 == ap_CS_fsm_state7) & (icmp_ln313_fu_900_p2 == 1'd1))) begin
...
always @ (*) begin
    if ((~((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078)) & (1'b1 == ap_CS_fsm_state7) & (icmp_ln79_fu_987_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln313_fu_900_p2 == 1'd1))) begin
        if ((icmp_ln317_fu_946_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((outidx_q0 == 2'd0)) begin
        ap_phi_mux_tmp_data_0_V_2_phi_fu_411_p8 = acc_0_V_fu_870_p2;
    end else if (((outidx_q0 == 2'd1) | (outidx_q0 == 2'd2) | (outidx_q0 == 2'd3))) begin
...
always @ (*) begin
    if ((outidx_q0 == 2'd1)) begin
        ap_phi_mux_tmp_data_1_V_phi_fu_392_p8 = acc_0_V_fu_870_p2;
    end else if (((outidx_q0 == 2'd2) | (outidx_q0 == 2'd3) | (outidx_q0 == 2'd0))) begin
...
always @ (*) begin
    if ((outidx_q0 == 2'd2)) begin
        ap_phi_mux_tmp_data_2_V_phi_fu_373_p8 = acc_0_V_fu_870_p2;
    end else if (((outidx_q0 == 2'd1) | (outidx_q0 == 2'd3) | (outidx_q0 == 2'd0))) begin
...
always @ (*) begin
    if (((outidx_q0 == 2'd1) | (outidx_q0 == 2'd2) | (outidx_q0 == 2'd0))) begin
        ap_phi_mux_tmp_data_3_V_phi_fu_354_p8 = tmp_data_3_V_745_reg_338;
    end else if ((outidx_q0 == 2'd3)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (icmp_ln129_reg_1097 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state7) & (1'd1 == and_ln289_4_reg_1078))) begin
...
always @ (*) begin
    if ((~((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078)) & (1'b1 == ap_CS_fsm_state7) & (1'd1 == and_ln289_4_reg_1078))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state7 : begin
            if ((~((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078)) & (1'b1 == ap_CS_fsm_state7) & (icmp_ln79_fu_987_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078)) & (icmp_ln79_fu_987_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state7;
            end
...
assign acc_0_V_fu_870_p2 = (tmp_21_fu_856_p6 + trunc_ln5_fu_847_p4);

assign add_ln321_fu_951_p2 = (pY_3_load_reg_1066 + 32'd1);

assign add_ln323_fu_962_p2 = (sY_3_load_reg_1056 + 32'd1);

assign add_ln326_fu_905_p2 = (pX_3_load_reg_1072 + 32'd1);

assign add_ln328_fu_916_p2 = (sX_3_load_reg_1046 + 32'd1);
...
always @ (*) begin
    ap_block_state7 = ((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078));
end

always @ (*) begin
    ap_condition_239 = (~((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078)) & (1'b1 == ap_CS_fsm_state7));
end

always @ (*) begin
    ap_condition_345 = (~((io_acc_block_signal_op150 == 1'b0) & (1'd1 == and_ln289_4_reg_1078)) & (1'b1 == ap_CS_fsm_state7) & (icmp_ln313_fu_900_p2 == 1'd1));
end

assign ap_enable_pp1 = (ap_idle_pp1 ^ 1'b1);

assign ap_phi_reg_pp1_iter1_tmp_data_0_V_2_reg_406 = 'bx;

assign ap_phi_reg_pp1_iter1_tmp_data_1_V_reg_387 = 'bx;

assign ap_phi_reg_pp1_iter1_tmp_data_2_V_reg_368 = 'bx;

assign ap_phi_reg_pp1_iter1_tmp_data_3_V_reg_349 = 'bx;
...
assign icmp_ln148_fu_886_p2 = (($signed(in_index_fu_880_p2) > $signed(32'd8)) ? 1'b1 : 1'b0);
...
assign icmp_ln289_6_fu_627_p2 = (($signed(tmp_7_fu_617_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);

assign icmp_ln289_fu_577_p2 = ((sX_3 == 32'd2) ? 1'b1 : 1'b0);

assign icmp_ln313_fu_900_p2 = ((pX_3_load_reg_1072 == 32'd27) ? 1'b1 : 1'b0);

assign icmp_ln317_fu_946_p2 = ((pY_3_load_reg_1066 == 32'd27) ? 1'b1 : 1'b0);

assign icmp_ln79_fu_987_p2 = ((indvar_flatten54_reg_260 == 10'd783) ? 1'b1 : 1'b0);

assign in_index_fu_880_p2 = (in_index_0_i_i_i_i53_reg_294 + 32'd1);

assign io_acc_block_signal_op150 = (res_V_data_3_V_full_n & res_V_data_2_V_full_n & res_V_data_1_V_full_n & res_V_data_0_V_full_n);
...
assign outidx_address0 = zext_ln133_fu_651_p1;
...
assign select_ln148_fu_892_p3 = ((icmp_ln148_fu_886_p2[0:0] === 1'b1) ? 32'd0 : in_index_fu_880_p2);
...
assign select_ln203_12_fu_520_p3 = ((trunc_ln201_fu_497_p1[0:0] === 1'b1) ? kernel_data_V_5_load_reg_1020 : kernel_data_V_4);

assign select_ln203_13_fu_539_p3 = ((trunc_ln201_fu_497_p1[0:0] === 1'b1) ? kernel_data_V_8_load_reg_1025 : kernel_data_V_7);

assign select_ln203_fu_501_p3 = ((trunc_ln201_fu_497_p1[0:0] === 1'b1) ? kernel_data_V_2144_load_reg_1015 : kernel_data_V_1143);

assign select_ln323_fu_967_p3 = ((icmp_ln289_4_reg_1061[0:0] === 1'b1) ? 32'd2 : add_ln323_fu_962_p2);

assign select_ln328_fu_921_p3 = ((icmp_ln289_reg_1051[0:0] === 1'b1) ? 32'd2 : add_ln328_fu_916_p2);

assign start_out = real_start;

assign tmp_7_fu_617_p4 = {{pX_3[31:1]}};

assign tmp_fu_597_p4 = {{pY_3[31:1]}};

assign trunc_ln139_fu_669_p1 = in_index_0_i_i_i_i53_reg_294[3:0];

assign trunc_ln201_fu_497_p1 = i_iw_0_i_i_i_i_reg_272[0:0];

assign trunc_ln5_fu_847_p4 = {{r_V_fu_993_p2[25:10]}};
