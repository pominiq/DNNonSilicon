...
set DataType0 [list "nnet::array<ap_fixed<32, 16, 5, 3, 0>, 1>" "struct array" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "nnet::array<ap_fixed<32, 16, 5, 3, 0>, 10>" "struct array" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
