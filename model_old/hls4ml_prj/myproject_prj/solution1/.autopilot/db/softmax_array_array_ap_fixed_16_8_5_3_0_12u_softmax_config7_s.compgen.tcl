...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { res_V_data_8_V_TDATA { O 16 vector } res_V_data_8_V_TVALID { O 1 bit } res_V_data_8_V_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'res_V_data_8_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { res_V_data_9_V_TDATA { O 16 vector } res_V_data_9_V_TVALID { O 1 bit } res_V_data_9_V_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'res_V_data_9_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { res_V_data_10_V_TDATA { O 16 vector } res_V_data_10_V_TVALID { O 1 bit } res_V_data_10_V_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'res_V_data_10_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { res_V_data_11_V_TDATA { O 16 vector } res_V_data_11_V_TVALID { O 1 bit } res_V_data_11_V_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'res_V_data_11_V'"
}
}
